...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: We're observing the contract by assuming the address points to a mutable u32.
    // We dereference the address and assign a new value to it without reading or writing outside
    // the bounds of the pointed-to u32.
    unsafe {
        // Cast the usize back to a mutable pointer to u32.
